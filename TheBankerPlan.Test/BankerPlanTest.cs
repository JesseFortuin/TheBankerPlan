namespace TheBankerPlan.Test
{
    public class BankerPlanTest
    {
        ...
        public void FortuneTests(int deposit, double interest, int withdraw, int numberOfYears, double inflaion, bool expected)
        {
            //arrange
            IBankerPlan plan = new BankerPlan();

            //act
            var actual = plan.Fortune(deposit, interest, withdraw, numberOfYears, inflaion);
